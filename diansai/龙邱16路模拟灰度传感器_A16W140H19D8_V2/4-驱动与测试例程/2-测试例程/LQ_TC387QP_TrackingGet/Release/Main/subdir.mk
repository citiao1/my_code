...
"Main/Cpu2_Main.o":"Main/Cpu2_Main.src" "Main/subdir.mk"
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
"Main/Cpu3_Main.src":"../Main/Cpu3_Main.c" "Main/subdir.mk"
	cctc -cs --dep-file="$*.d" --misrac-version=2004 -D__CPU__=tc38x "-fF:/LQ_Project/TC264_297_3/TC387/TC387_SoftWare_LIB_260128/LQ_TC387_LIB_MBG_V7.0.1/Release/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O2 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc38x -Y0 -N0 -Z0 -o "$@" "$<"
"Main/Cpu3_Main.o":"Main/Cpu3_Main.src" "Main/subdir.mk"
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
...
clean-Main:
	-$(RM) ./Main/Cpu0_Main.d ./Main/Cpu0_Main.o ./Main/Cpu0_Main.src ./Main/Cpu1_Main.d ./Main/Cpu1_Main.o ./Main/Cpu1_Main.src ./Main/Cpu2_Main.d ./Main/Cpu2_Main.o ./Main/Cpu2_Main.src ./Main/Cpu3_Main.d ./Main/Cpu3_Main.o ./Main/Cpu3_Main.src ./Main/irq.d ./Main/irq.o ./Main/irq.src
