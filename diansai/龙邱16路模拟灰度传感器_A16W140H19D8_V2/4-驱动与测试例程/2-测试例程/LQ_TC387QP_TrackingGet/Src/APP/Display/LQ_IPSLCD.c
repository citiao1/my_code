 ...
 * @date     2026/01/28
 */
void LCD_Init(unsigned char DIR)
{
    USE_HORIZONTAL = DIR;
#ifdef USE_LQTC3X7_mVA  /* 区分迷你驱控一体板与通用母板LCD接口*/

    #if USE_QSPI
    /* 260128,V1一体板，屏幕SPI引脚 不对应 */
    //LQ_QSPI_Init(IfxQspi1_SCLK_P11_6_OUT, IfxQspi1_MTSRB_P11_9_IN, IfxQspi1_MRSTA_P10_1_IN, IfxQspi1_SLSO6_P20_10_OUT, 0, 30 * 1000 * 1000);
    #else
