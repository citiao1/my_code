...
#ifdef USE_LQTC3X7_mVA

#define IPS_CK  P11_6   // IPS CK管脚
#define IPS_DI  P11_9   // IPS DI管脚
#define IPS_RST P11_10  // IPS RST管脚
#define IPS_DC  P10_1   // IPS DC管脚
#define IPS_CS  P10_2   // IPS CS管脚
