...
/*************************************************************************
 * @name     LQ_GPIO_Output_Demo
 *
 * @brief    GPIO 输出示例
 * @param    none
 * @return   none
 * 
 * @note     初始化指定 GPIO 引脚并输出高电平，然后每隔 500ms 翻转输出状态
 *************************************************************************/
void LQ_GPIO_Output_Demo(void)
{
    LQEnum_GPIO_Pin_t led = GPIO_Pin_A_15;  // LED 引脚选择
    ...
    while (1)
    {
        LQ_GPIO_TogglePin(led);             // 翻转 led 引脚输出状态(LED灯)
