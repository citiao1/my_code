...
typedef enum
{
    FEEDFORWARD_NONE = 0x000,
    CURRENT_FEEDFORWARD = 0x001,
    SPEED_FEEDFORWARD = 0x010,
    ANGLE_FEEDFORWARD = 0x100,
    CURRENT_AND_SPEED_FEEDFORWARD = 0x011
}Feedfoward_Type_e;
...
typedef struct 
{
    ...
    Feedfoward_Type_e Feedfoward_flag;
...
typedef struct 
{
    float *other_speed_feedback_prt;
    float *other_angle_feedback_prt;
    float *angle_feedforward_prt;
    float *speed_feedforward_ptr;
    float *current_feedforward_ptr;
