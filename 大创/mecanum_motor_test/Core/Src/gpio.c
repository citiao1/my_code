...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GRAY_SEL_A_Pin|GRAY_SEL_B_Pin|GRAY_SEL_C_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : OLED_DC_Pin OLED_RST_Pin OLED_DIN_Pin OLED_CLK_Pin */
