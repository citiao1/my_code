...
(function(vue) {
  ...
  const _sfc_main$1 = {
    ...
    methods: {
      ...
      connectMQTT() {
        ...
        try {
          this.client = new Paho$1.MQTT.Client(this.host, this.port, "/mqtt", clientId);
        } catch (e) {
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", { class: "content" }, [
      vue.createElementVNode("div", { class: "header" }, [
        vue.createElementVNode("h2", { class: "title" }, "🏠 智能家居控制"),
        vue.createElementVNode("p", { class: "status" }, [
          vue.createTextVNode("状态: "),
          vue.createElementVNode(
            "span",
            {
              class: vue.normalizeClass({ online: $data.isConnected })
            },
      ...
      vue.createElementVNode("div", { class: "btn-group" }, [
        vue.createElementVNode("button", {
          class: "btn on-btn",
          onClick: _cache[0] || (_cache[0] = ($event) => $options.sendCmd("ON"))
        }, "开灯"),
        vue.createElementVNode("button", {
          class: "btn off-btn",
          onClick: _cache[1] || (_cache[1] = ($event) => $options.sendCmd("OFF"))
        }, "关灯")
      ]),
      vue.createElementVNode("div", { class: "slider-area" }, [
        vue.createElementVNode(
          "p",
          null,
          "当前亮度: " + vue.toDisplayString($data.brightness) + "%",
          1
          /* TEXT */
        ),
        vue.createElementVNode("slider", {
          value: $data.brightness,
          onChange: _cache[2] || (_cache[2] = (...args) => $options.onSliderChange && $options.onSliderChange(...args)),
          min: "0",
          max: "100",
          "show-value": "",
          "block-size": "20"
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "C:/Users/123/Desktop/my_code/SmartHomeApp/pages/index/index.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/123/Desktop/my_code/SmartHomeApp/App.vue"]]);
  function createApp() {
