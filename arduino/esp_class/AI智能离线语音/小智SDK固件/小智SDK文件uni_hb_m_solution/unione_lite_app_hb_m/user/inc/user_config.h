...
#define USE_SAMPLE_PROTOCOL   1       ///< 0: don't use, 1: use (cannot set to 0 if USE_UNIONE_PROTOCOL is 1)
...
#define USER_UART_BAUD_RATE   19200   ///< 4800/9600/19200/38400/57600/115200
...
@{*/
#define USER_RUN_DEMO         1       ///< 1: select a demo to run, 1: no user demo,
