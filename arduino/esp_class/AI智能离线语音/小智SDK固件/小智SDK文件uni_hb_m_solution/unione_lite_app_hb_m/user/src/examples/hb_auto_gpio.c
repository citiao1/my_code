...
static void _custom_setting_cb(USER_EVENT_TYPE event,
  ...
  if (context) {
    ...
    } else if (0 == uni_strcmp(setting->cmd, "BrightnessUp")) {
      user_pwm_change_duty(PWM_NUM_2_B3, 0);
    } else if (0 == uni_strcmp(setting->cmd, "BrightnessOff")) {
      user_pwm_change_duty(PWM_NUM_2_B3, 100);
    } else if (0 == uni_strcmp(setting->cmd, "dakaifengshan")) {
      user_gpio_set_value(GPIO_NUM_A26, 1);
    } else if (0 == uni_strcmp(setting->cmd, "guanbifengshan")) {
      user_gpio_set_value(GPIO_NUM_A26, 0);
    } else if (0 == uni_strcmp(setting->cmd, "dakaiyinyue")) {
      user_gpio_set_value(GPIO_NUM_A27, 1);
    } else if (0 == uni_strcmp(setting->cmd, "guanbiyinyue")) {
      user_gpio_set_value(GPIO_NUM_A27, 0);
    } else if (0 == uni_strcmp(setting->cmd, "dakaikaiguan")) {
      user_gpio_set_value(GPIO_NUM_B6, 1);
    } else if (0 == uni_strcmp(setting->cmd, "guanbikaiguan")) {
      user_gpio_set_value(GPIO_NUM_B6, 0);
    } else if (0 == uni_strcmp(setting->cmd, "tiaoliang")) {
      user_pwm_duty_dec(PWM_NUM_2_B3, 10);
    } else if (0 == uni_strcmp(setting->cmd, "tiaoan")) {
      user_pwm_duty_inc(PWM_NUM_2_B3, 10);
    } else {
...
int hb_auto_gpio(void) {
  ...
  user_pwm_init(PWM_NUM_2_B3, 20000, false);
  user_pwm_start(PWM_NUM_2_B3, 0);
