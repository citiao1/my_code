...
typedef enum  // 枚举ERU通道
{
    ...
    ERU_CH1_REQ10_P14_3  = 1*3,                                                     // 通道1可选引脚

    ERU_CH2_REQ14_P02_1  = 2*3,                                                     // 通道2可选引脚
    ERU_CH3_REQ6_P02_0   = 3*3,  ERU_CH3_REQ15_P14_1,                               // 通道3可选引脚

    // 特别注意通道4 与 通道6都被摄像头占用
    // 特别注意通道4 与 通道6都被摄像头占用
    // 特别注意通道4 与 通道6都被摄像头占用
    // 通道4与通道0 共用中断函数 在中断内通过判断标志位来识别是哪个通道触发的中断
    ERU_CH4_REQ13_P15_5  = 4*3,  ERU_CH4_REQ8_P33_7,                                // 通道4可选引脚
    // 通道6与通道2 共用中断函数
    ERU_CH6_REQ12_P11_10 = 6*3,                                                     // 通道6可选引脚
    // 通道7与通道3 共用中断函数
