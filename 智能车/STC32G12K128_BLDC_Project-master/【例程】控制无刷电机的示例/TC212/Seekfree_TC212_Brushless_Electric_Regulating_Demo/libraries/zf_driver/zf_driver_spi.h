...
typedef enum                                            // 枚举SPI CLK引脚 此枚举定义不允许用户修改
{
    ...
    SPI1_SCLK_P11_6  = 1*102+0*6 ,                      // SPI1 CLK 引脚可选范围

    SPI2_SCLK_P15_3  = 2*102+0*6 ,                      // SPI2 CLK 引脚可选范围

    SPI3_SCLK_P02_7  = 3*102+0*6 ,                      // SPI3 CLK 引脚可选范围
}spi_sck_pin_enum;
...
typedef enum                                            // 枚举SPI MOSI引脚 此枚举定义不允许用户修改
{
    ...
    SPI1_MOSI_P10_3  = 1*102+1*6 , SPI1_MOSI_P11_9,     // SPI1 MOSI引脚可选范围

    SPI2_MOSI_P15_5  = 2*102+1*6 ,                      // SPI2 MOSI引脚可选范围

    SPI3_MOSI_P02_6  = 3*102+1*6 , SPI3_MOSI_P10_6,     // SPI3 MOSI引脚可选范围
}spi_mosi_pin_enum;
...
typedef enum                                            // 枚举SPI MISO引脚 此枚举定义不允许用户修改
{
    ...
    SPI1_MISO_P11_3  = 1*102+2*6 ,                      // SPI1 MISO引脚可选范围

    SPI2_MISO_P15_2  = 2*102+2*6 ,                      // SPI2 MISO引脚可选范围

    SPI3_MISO_P02_5  = 3*102+2*6 ,                      // SPI3 MISO引脚可选范围
}spi_miso_pin_enum;

typedef enum                                            // 枚举SPI CS引脚 此枚举定义不允许用户修改
{
    SPI0_CS0_P20_8   = 0*102+3*6 ,                      // SPI0 CS 引脚可选范围
    ...
    SPI1_CS0_P20_8   = 1*102+3*6 ,                      // SPI1 CS 引脚可选范围
