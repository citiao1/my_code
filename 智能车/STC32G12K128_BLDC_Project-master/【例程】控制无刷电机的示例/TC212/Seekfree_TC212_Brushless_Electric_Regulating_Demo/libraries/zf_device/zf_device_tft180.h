...
#define TFT180_SDA_PIN_IN               (SPI2_MISO_P15_2)                       // 硬件 SPI MISO 引脚  TFT没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动====================================================
#endif

#define TFT180_RES_PIN                  (P11_11)                                // 液晶复位引脚定义
#define TFT180_DC_PIN                   (P11_12)                                // 液晶命令位引脚定义
#define TFT180_CS_PIN                   (P15_2)                                 // CS 片选引脚
#define TFT180_BL_PIN                   (P00_0)                                 // 液晶背光引脚定义
