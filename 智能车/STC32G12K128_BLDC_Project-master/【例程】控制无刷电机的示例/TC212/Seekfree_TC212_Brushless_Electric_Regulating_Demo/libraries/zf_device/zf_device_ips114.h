...
#define IPS114_SDA_IN_PIN               (SPI2_MISO_P15_2)                       // 定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动====================================================
#endif

#define IPS114_RST_PIN                  (P11_11)                                // 液晶复位引脚定义
#define IPS114_DC_PIN                   (P11_12)                                // 液晶命令位引脚定义
#define IPS114_CS_PIN                   (P15_2)                                 // CS 片选引脚
#define IPS114_BLK_PIN                  (P00_0)                                 // 液晶背光引脚定义
