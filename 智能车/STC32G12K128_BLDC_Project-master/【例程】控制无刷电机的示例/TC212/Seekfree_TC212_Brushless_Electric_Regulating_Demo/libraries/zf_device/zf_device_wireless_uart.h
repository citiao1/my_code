...
#define WIRELESS_UART_INDEX         (UART_0)                                    // 无线串口对应使用的串口号
#define WIRELESS_UART_BUAD_RATE     (115200)                                    // 无线串口对应使用的串口波特率
#define WIRELESS_UART_TX_PIN        (UART0_RX_P14_1)                            // 无线串口对应模块的 TX 要接到单片机的 RX
#define WIRELESS_UART_RX_PIN        (UART0_TX_P14_0)                            // 无线串口对应模块的 RX 要接到单片机的 TX
