...
#define OLED_D1_PIN_IN                  (SPI2_MISO_P15_2)                       //硬件 SPI MISO 引脚  OLED没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动====================================================
#endif

#define OLED_RES_PIN                    (P11_11)                                // 液晶复位引脚定义
#define OLED_DC_PIN                     (P11_12 )                               // 液晶命令位引脚定义
