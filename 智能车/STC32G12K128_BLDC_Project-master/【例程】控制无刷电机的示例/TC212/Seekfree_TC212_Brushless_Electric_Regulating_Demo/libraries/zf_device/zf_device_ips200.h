...
#define IPS200_SDA_IN_PIN_SPI           (SPI2_MISO_P15_2 )                      // 硬件 SPI MISO 引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动====================================================
#endif
// 如果使用的是单排排针的两寸屏幕 SPI 驱动控制引脚 可以修改
#define IPS200_RST_PIN_SPI              (P11_11)                                // 液晶复位引脚定义
#define IPS200_DC_PIN_SPI               (P11_12)                                // 液晶命令位引脚定义
#define IPS200_CS_PIN_SPI               (P15_2)
#define IPS200_BLk_PIN_SPI              (P00_0)
