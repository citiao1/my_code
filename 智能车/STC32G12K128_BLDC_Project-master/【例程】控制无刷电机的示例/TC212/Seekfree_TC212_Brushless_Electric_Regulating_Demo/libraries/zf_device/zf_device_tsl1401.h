...
#define TSL1401_AO_PIN          (ADC0_CH9_A9)                                   // 对应第一个 TSL1401 的 AO 引脚
#define TSL1401_AO_PIN1         (ADC0_CH10_A10)                                 // 对应第二个 TSL1401 的 AO 引脚
// TSL1401 的控制引脚定义 多个 TSL1401 建议将控制引脚直接并联
#define TSL1401_CLK_PIN         (P02_0)                                         // TSL1401 的 CLK 引脚定义
#define TSL1401_SI_PIN          (P02_1)                                         // TSL1401 的 SI 引脚定义
