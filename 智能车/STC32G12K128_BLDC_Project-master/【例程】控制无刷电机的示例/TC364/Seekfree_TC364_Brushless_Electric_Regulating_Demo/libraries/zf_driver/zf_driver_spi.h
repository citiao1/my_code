...
typedef enum                                                                                                                // 枚举SPI CLK引脚 此枚举定义不允许用户修改
{
    ...
    SPI3_SCLK_P02_7  = 3*102+0*6 , SPI3_SCLK_P10_8, SPI3_SCLK_P22_3,                                                        // SPI3 CLK 引脚可选范围
}spi_sck_pin_enum;
...
typedef enum                                                                                                                // 枚举SPI MOSI引脚 此枚举定义不允许用户修改
{
    ...
    SPI3_MOSI_P02_6  = 3*102+1*6 , SPI3_MOSI_P10_6, SPI3_MOSI_P22_0,                                                        // SPI3 MOSI引脚可选范围
}spi_mosi_pin_enum;
...
typedef enum                                                                                                                // 枚举SPI MISO引脚 此枚举定义不允许用户修改
{
    ...
    SPI3_MISO_P02_5  = 3*102+2*6 , SPI3_MISO_P10_7, SPI3_MISO_P22_1                                                         // SPI3 MISO引脚可选范围
}spi_miso_pin_enum;
