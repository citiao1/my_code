...
#define ABS_ENCODER_SPI_SCK_PIN   	SPI3_SCLK_P43   	//接模块 SCLK
#define ABS_ENCODER_SPI_MISO_PIN  	SPI3_SCLK_P43  		//接模块 MISO
#define ABS_ENCODER_SPI_MOSI_PIN  	SPI3_SCLK_P43   	//接模块 MOSI
