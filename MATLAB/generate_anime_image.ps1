...
$outDir = Join-Path (Get-Location) "output\imagegen"
$outFile = Join-Path $outDir "moonlight_anime_character.png"
$promptFile = Join-Path $outDir "moonlight_anime_character_prompt.txt"
